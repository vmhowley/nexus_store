            ...
            <div className="fixed top-4 right-4 bg-primary text-white p-4 rounded-lg shadow-lg z-50 animate-bounce">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    Order #{newOrderAlert.id.slice(0, 8)} - $
                  ...
                  <Link className="p-4" to={`/order-success/${order.id}`}>
                    ...
                    >
                      ...
                      {order.status === "pending" && (
                        <button
                          onClick={() =>
                            handleOrderStatusUpdate(order.id, "done")
                          }
                ...
                <div className="bg-dark rounded-xl p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <input
                            ...
                            onChange={(e) =>
                              handleSpecsChange("cpu", e.target.value)
                            }
                            placeholder="CPU"
                            className="w-full bg-light text-dark px-4 py-2 rounded-lg border border-gray-600 focus:outline-none focus:border-primary"
                          />
                        ...
                        <div>
                          <input
                            ...
                            onChange={(e) =>
                              handleSpecsChange("gpu", e.target.value)
                            }
                            placeholder="GPU"
                            className="w-full bg-light text-dark px-4 py-2 rounded-lg border border-gray-600 focus:outline-none focus:border-primary"
                          />
                        ...
                        <div>
                          <input
                            ...
                            onChange={(e) =>
                              handleSpecsChange("ram", e.target.value)
                            }
                            placeholder="RAM"
                            className="w-full bg-light text-dark px-4 py-2 rounded-lg border border-gray-600 focus:outline-none focus:border-primary"
                          />
                        ...
                        <div>
                          <input
                            ...
                            onChange={(e) =>
                              handleSpecsChange("disk", e.target.value)
                            }
                            placeholder="Storage"
                            className="w-full bg-light text-dark px-4 py-2 rounded-lg border border-gray-600 focus:outline-none focus:border-primary"
                          />
                    ...
                    <div className="space-y-6">
                      {Object.entries(formData.configurations).map(
                        ([type, options]) => (
                          <div key={type}>
