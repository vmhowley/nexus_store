    ...
    <div className="pt-20 bg-gray-900 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          <Building2 className="h-16 w-16 text-purple-500 mx-auto mb-6" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {solutions.map((solution, index) => {
            ...
            return (
              <div key={index} className="bg-gray-800 rounded-2xl p-8 border border-purple-500/20">
        ...
        <div className="bg-gradient-to-r from-purple-900/50 to-pink-900/50 rounded-2xl p-12 text-center">
          ...
          <button className="bg-white text-purple-900 px-8 py-3 rounded-lg font-medium hover:bg-gray-100 transition-colors">
