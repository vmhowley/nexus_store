...
export default function Features() {
  return (
    <div className="bg-gray-800 py-24 relative overflow-hidden">
      <div className="absolute inset-0 bg-lime-500/5 backdrop-blur-3xl"></div>
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => {
            const Icon = feature.icon;
            return (
              <div key={index} className="bg-gray-900/50 backdrop-blur-lg rounded-2xl p-8 border border-lime-500/20">
